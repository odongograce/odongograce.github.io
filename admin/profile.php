...
if(isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if(!empty($password)){      
        ...
        if($stmt->execute()){        
            ...
            header('Location: ./profile.php?status=account_updated');
            $stmt->close();
            $conn->close();
            exit();
        }else{
            header('Location: ./profile.php?error=error_editing_account');
            exit();
        }
    ...
    if($stmt->execute()){        
        ...
        header('Location: ./profile.php?error=error_updating_account');
        exit();
    }
}
// ******************************************************  END ACCOUNT
...
<?php include './views/profile.view.php'; ?>

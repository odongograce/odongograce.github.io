<form action="./add_service.php" method="post" class="form" id="service-form">
    <h3>Add Service</h3>
    <!-- Error Messages -->
    <?php error_msg("error_adding_service", "There was an error adding service! Please Try Again"); ?>
    <input type="text" name="serviceName" id="service-name" placeholder="Service">
    <textarea name="description" rows="10" placeholder="Description" id="service-description"></textarea>
    <input type="number" name="serviceAmount" id="service-amount" placeholder="Amount">

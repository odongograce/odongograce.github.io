                                ...
                                <div class="pagitations">
                                    <ul class="pagination-list">
                                        <?php
                                            ...
                                            if($page > 2){
                                                ?>
                                                    <li><a href="./users.php?page=1" class="pagination-link">1</a></li>
                                                    <?php
                                            ...
                                            if($page -1 > 0){
                                                ?>
                                                <li><a href="./users.php?page=<?php echo $page - 1; ?>" class="pagination-link">&larr;</a></li>
                                                <?php
                                            }
                                            ?>
                                            <!--Display the current page -->
                                            <li><a href="./users.php?page=<?php echo $page; ?>" class="pagination-link current-page"><?php echo $page; ?></a></li>
                                            <?php

                                            //Display 1 page after the current page
                                            if($page + 1 < $number_of_pages + 1){
                                                ?>
                                                <li><a href="./users.php?page=<?php echo $page + 1; ?>" class="pagination-link">&rarr;</a></li>
                                                <?php
                                            }
                                            ...
                                            if($page < $number_of_pages){
                                                if($page < $number_of_pages - 2){
                                                    ?>
                                                        <li><a>...</a></li>
                                                        <li><a href="./users.php?page=<?php echo $number_of_pages; ?>" class="pagination-link"><?php echo $number_of_pages; ?></a></li>

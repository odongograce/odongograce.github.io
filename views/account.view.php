<section class="sign-up">
    <div class="container">
        <!-- a form that uses the POST method to submit data to the endpoint./account.php -->
        <form method="POST" action="./account.php" class="form" id="signup-form">
            <h2>Account</h2>
            <h3>Update Account</h3>

            <!-- Success Message -->
            <?php success_message("account_updated","Account Updated Succesfully");?>
            ...
            <input type="text" name="firstName" id="firstName" placeholder="First Name" value="<?php echo $first_name; ?>">
            ...
            <input type="phone" name="phone" id="phone" placeholder="Phone: Eg. 0712345678" value="<?php echo $phone; ?>">
